				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type='text' class="form-control" name="kategori" value="<?php echo $data_cek['kategori']; ?>"
							/>
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control" name="jumlah_buku" value="<?php echo $data_cek['jumlah_buku']; ?>">
						</div>
