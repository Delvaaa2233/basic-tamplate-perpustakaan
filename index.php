	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">
					<img src="dist/img/logosmp2.png" alt="Logo" width="37px">
					<b>E-Library</b>
				</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										Perpustakaan SMPN 2 AMPEK ANGKEK
									</b>
								</span>
							</a>
						</li>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					?>
						...
						<li class="treeview">
							<a href="?page=dashboard_statistik">
				...
				if (isset($_GET['page'])) {
					...
					switch ($hal) {
						...
						case 'MyApp/print_laporan':
							...
							//dashboard statistik
						case 'dashboard_statistik':
                           include "admin/statistik/dashboard_statistik.php";
                           break;

						   //chatbot petugas
						case 'chatbot':
                           include "home/chat_petugas.php";
                           break;
